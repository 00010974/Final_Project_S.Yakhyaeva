...
export default function ProductForm({_id, title:exsistingTitle, description:exsistingDescription, price:exsistingPrice, images:exsistingImages, category:assignedCategory}) {
