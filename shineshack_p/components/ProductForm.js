...
export default function ProductForm({_id, title:exsistingTitle, description:exsistingDescription, price:exsistingPrice, images:exsistingImages, category:assignedCategory, properties:assignedProperties}) {
            ...
            <form onSubmit={saveProduct}>
                ...
                <div className="mb-2 flex flex-wrap gap-1">
                    ...
                    {!!images?.length && images.map(link => (
                        <div key={link} className="h-24 bg-primary shadow-sm rounded-lg border border-gray-200">
                    ...
                    <label className="w-24 h-24 cursor-pointer text-center flex flex-col items-center justify-center text-sm gap-1 text-text rounded-lg bg-primary shadow-sm border border-primary">
